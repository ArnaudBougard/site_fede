...
<nav class="navbar navbar-default hidden-md hidden-sm hidden-xs" id="nav">
	...
	<ul class="menuul">
		...
		<li class="menuli">
			...
			<a 
			<?php 
			if($page == "index/index.php" or $page == "index/"){echo 'class="active"';} 
			?> 
			href="../index/index.php">Accueil
			</a>
		...
		<li class="dropdown menuli" href="">
			...
			<a 
			<?php 
				if($page == "federale/about.php" or $page == "federale/adhesion.php" or $page == "federale/statuts.php" 
					or $page == "federale/pv.php" or $page == "federale/commissions.php"){
						echo 'class="active"';} 
			?>
			href="../federale/about.php">La Fédérale
			</a>

			<ul class="dropdown-content">
				<li class="dcli"><a href="../federale/about.php">Qui sommes-nous ?</a></li>
		...
		<li class="dropdown menuli" href="#">
			...
			<a 
			<?php if($page == "folklore/fetes.php" or $page == "folklore/regionales.php" or $page == "folklore/bleusaille.php" or $page == "folklore/chants.php" ){echo 'class="active"';} 
			?> 
			href="../folklore/fetes.php">Folklore
			</a>
		...
		<li class="dropdown menuli" href="#">
			...
			<a 
			<?php 
			if($page == "cercles/indexcercles.php" or $page == "cercles/cercles.php?id=openBar" or $page == "cercles/cercles.php?id=openCap" or $page == "cercles/cercles.php?id=openCpv" or $page == "cercles/cercles.php?id=openCulture" or $page == "cercles/cercles.php?id=openMagellan" or $page == "cercles/cercles.php?id=openMm" or $page == "cercles/cercles.php?id=openMutu" or $page == "cercles/cercles.php?id=openPeyresq" or $page == "cercles/cercles.php?id=openRadio" or $page == "cercles/cercles.php?id=openScientifique" or $page == "cercles/cercles.php?id=openSdm" or $page == "cercles/cercles.php?id=openSports" ){echo 'class="active"';} 
			?> 
			href="../cercles/indexcercles.php">Cercles
			</a>

...
<nav class="navbar navbar-default hidden-md hidden-sm hidden-xs" id="nav">
	...
	<ul class="menuul">
		...
		<li class="menuli">
			...
			<a <?php if($page == "index/index.php" or $page == "index/"){echo 'class="active"';} ?> href="../index/index.php">Accueil
			</a>
		...
		<li class="dropdown menuli">
			...
			<a <?php if($page == "federale/about.php" or $page == "federale/adhesion.php" or $page == "federale/statuts.php" or $page == "federale/pv.php" or $page == "federale/commissions.php"){echo 'class="active"';} ?> href="../federale/about.php">La Fédérale
			</a>
		...
		<li class="dropdown menuli">
			...
			<a <?php if($page == "folklore/fetes.php" or $page == "folklore/regionales.php" or $page == "folklore/bleusaille.php" or $page == "folklore/chants.php" ){echo 'class="active"';} ?> href="../folklore/fetes.php">Folklore
			</a>
		...
		<li class="dropdown menuli">
			...
			<a <?php if($page == "activites/game.php" or $page == "activites/voyageQ.php" or $page == "activites/ski.php" or $page == "activites/peyresq.php" or $page == "activites/isw.php"){echo 'class="active"';} ?>>Évènements majeurs</a>

...
<div class="footer" style="width: 100%; margin-top: 2em;">

  <div class="row">

    <div class="col-sm-4 col-xs-12 hidden-xs ">
      <img src='../../assets/img/logoFede2.png' style="width:50%; display: block; margin: 0 auto; margin-top: 2em;" alt='Logo du site'/>
    </div>
    ...
    <div class="col-sm-4 col-xs-12 hidden-xs">
      <div class="links-foot">
        <ul>
          ...
          <li style="list-style-type: none;"><a class="link-foot" href="../contact/contact.php">Nous contacter</a></li>
        </ul>
      </div>
    </div>
